     ...
     <section>
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-10">
                <h5 class="text-center mt-2" style="color: black;">Delete Language Details</h5><hr>
         ...
         <form method="post" class="register-form">
            ...
            <input type="text"  name="lang_name"  value="<?php echo $n?>"><br><hr>
                ...
                <a href="viewlanguage.php" class="btn" style="background-color: black; color:white;">Cancel</a>
