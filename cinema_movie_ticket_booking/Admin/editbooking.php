...
$a="";
        ...
        if(isset($_POST["btn_update"]))
        {
            ...
            $sql = "UPDATE booking SET cust_id = $customer, show_id = $show, no_ticket = $ticket, seat_dt_id = $Seat, booking_date = '$b_date', total_amount = $amount WHERE id = $id;";       
     ...
     <section>
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-10">
                <h5 class="text-center mt-2" style="color: black;">Edit Booking Details</h5><hr>
