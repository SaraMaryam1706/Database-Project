     ...
     <section>
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-10">
                <h5 class="text-center mt-2" style="color: black;">Delete Genre Details</h5><hr>
         ...
         <form method="post" class="register-form">
            ...
            <input type="text"  name="genre_name"  value="<?php echo $n?>"><br><hr>
                ...
                <a href="viewgenre.php" class="btn" style="background-color: black; color:white;">Cancel</a>
